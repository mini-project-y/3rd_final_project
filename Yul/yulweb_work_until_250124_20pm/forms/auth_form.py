...
from wtforms.validators import DataRequired, Email  # DataRequired: 데이터 반드시 있어야해, 빈 칸 안됀다는 뜻
...
class RegisterForm(LoginForm):
    ...
    allergic_foods = StringField("Allergic Food", validators=[DataRequired("You have not entered Allergic Foods. Please enter them.")])

    favorite_food = StringField("Favorite Food", validators=[DataRequired("You have not entered Favorite Foods. Please enter them.")])
    disliked_food = StringField("Disliked Food", validators=[DataRequired("You have not entered Disliked Foods. Please enter them.")])
    preferred_food = StringField("Preferred Food", validators=[DataRequired("You have not entered Preferred Foods. Please enter them.")])
    non_preferred_food = StringField("Non Preferred Food", validators=[DataRequired("You have not entered Non Preferred Foods. Please enter them.")])
    ...
    # preferred_taste = StringField("Preferred Taste", validators=[DataRequired("You haven't selected a Preferred Taste. Please make a selection.")])
    preferred_taste = SelectMultipleField("Preferred Taste", 
                                          choices=[
                                              ('sweet', ''),
                                              ('sour', ''),
                                              ('spicy', ''),
                                              ...
                                              ('bitter', ''),
                                              ('greasy', '')
                                          ], validators=[DataRequired("You haven't selected a Preferred Taste. Please make a selection.")])
    non_preferred_taste = SelectMultipleField("Non Preferred Taste", 
                                          choices=[
                                              ('sweet', ''),
                                              ('sour', ''),
                                              ('spicy', ''),
                                              ...
                                              ('bitter', ''),
                                              ('greasy', '')
                                          ], validators=[DataRequired("You haven't selected a Non Preferred Taste. Please make a selection.")])
    excluded_meat = SelectMultipleField("Excluded Meats", 
                                        choices=[
                                            ('beef', ''),
                                            ('pork', ''),
                                            ('chicken', ''),
